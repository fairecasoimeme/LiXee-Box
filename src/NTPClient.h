...
class NTPClient {
  ...
  public:
    ...
    NTPClient(UDP& udp, const char* poolServerName, int timeOffset, String timezone);
    NTPClient(UDP& udp, const char* poolServerName, int timeOffset, String timezone, int updateInterval);
